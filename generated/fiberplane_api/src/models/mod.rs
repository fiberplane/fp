...
pub mod new_trigger_with_template_body;
pub use self::new_trigger_with_template_body::NewTriggerWithTemplateBody;
pub mod new_trigger_with_template_url;
pub use self::new_trigger_with_template_url::NewTriggerWithTemplateUrl;
pub mod notebook;
